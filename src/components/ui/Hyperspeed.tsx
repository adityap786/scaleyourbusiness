...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
    ...
    useEffect(() => {
        ...
        class App {
            ...
            constructor(container: any, options: any = {}) {
                ...
                // Cap pixel ratio — retina rendering is wasteful for a background effect
            ...
            initPasses() {
                ...
                this.bloomPass = new EffectPass(
                    ...
                    new BloomEffect({
                        ...
                        resolutionScale: this.isLowEnd ? 0.5 : 1
                    })
                );
                ...
                // Skip SMAA on mobile/low-end — it's expensive and barely noticeable on a bg
                if (!this.isMobile) {
            ...
            tick() {
                ...
                if (this.isVisible) {
                    ...
                    // Keep clock ticking to prevent time jumps when becoming visible again
                    this.clock.getDelta();
                }
    ...
    `;
        ...
        options.distortion = distortions[options.distortion as keyof typeof distortions] || distortions.turbulentDistortion;
        ...
        myApp.loadAssets().then(myApp.init as any);
    ...
    return <div id="lights" ref={hyperspeed} className="absolute inset-0 pointer-events-none"></div>;
};
