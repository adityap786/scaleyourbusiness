...
const TESTIMONIALS = [
    ...
    {
        quote: "We were stuck scaling our operations. Their automation injected 40 hours back into our week. It felt like we hired 5 invisible employees.",
        author: "DAVID ROUGE",
        role: "CEO, VELOCITY",
        offset: -30
    },
...
export function AestheticTestimonials() {
    ...
    return (
        <section 
            ref={containerRef} 
            className="relative py-32 md:py-48 bg-white border-y-[3px] border-black overflow-hidden isolate"
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16 md:gap-y-32 relative z-10">
                    {TESTIMONIALS.map((t, i) => (
                        <motion.div 
                            ...
                            style={{ 
                                marginTop: typeof window !== 'undefined' && window.innerWidth >= 768 ? t.offset : 0 
                            }}
                            className="group relative flex flex-col justify-between p-8 md:p-12 bg-white border-[3px] border-black shadow-[12px_12px_0px_0px_#000] hover:shadow-[16px_16px_0px_0px_#3b82f6] hover:-translate-y-2 transition-all duration-500 overflow-hidden"
                        >
                            ...
                            <p className="text-2xl md:text-3xl font-black text-black leading-[1.1] tracking-tight mb-12 mix-blend-exclusion">
                                "{t.quote}"
                            </p>
