...
export default function ContactPage() {
    ...
    const contactSchema = {
        ...
        'mainEntity': {
            ...
            'email': 'hello@scaleyourbusiness.online',
                                ...
                                <div className="lg:w-[60%] p-10 md:p-14 flex flex-col justify-center relative z-10 transition-colors duration-500 text-left lg:text-right">
                                    <div className="space-y-6">
                                        <div className="flex flex-row lg:flex-row-reverse items-center justify-start lg:justify-start gap-6 group-hover:-translate-x-4 transition-transform duration-500">
                                            ...
                                            <a href="mailto:hello@scaleyourbusiness.online" className="text-2xl md:text-4xl font-black text-black group-hover:text-white tracking-widest hover:underline decoration-4 underline-offset-8 transition-colors duration-500 block break-words break-all">
                                                hello@scaleyourbusiness.online
                                            </a>
                                        </div>
                                    </div>
                                </div>
